	...
	public static class Builder {
		...
		public CustomDialog create() {
			...
			if (neutral_btnText != null && confirm_btnText != null
				...
				((Button)layout.findViewById(R.id.neutral_btn)).setText(neutral_btnText);
				if (neutral_btnClickListener != null) {
					layout.findViewById(R.id.neutral_btn).setOnClickListener(
			...
			if (confirm_btnText != null) {
				...
				if (confirm_btnClickListener != null) {
					layout.findViewById(R.id.confirm_btn).setOnClickListener(
							new View.OnClickListener() {
								public void onClick(View v) {
			...
			if (cancel_btnText != null) {
				...
				if (cancel_btnClickListener != null) {
					layout.findViewById(R.id.cancel_btn).setOnClickListener(
							new View.OnClickListener() {
								public void onClick(View v) {
