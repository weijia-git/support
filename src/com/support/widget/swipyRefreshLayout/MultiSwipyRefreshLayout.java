 ...
 */
public class MultiSwipyRefreshLayout extends SwipyRefreshLayout {

    private View[] mSwipeableChildren;

    public MultiSwipyRefreshLayout(Context context) {
        super(context);
    }

    public MultiSwipyRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
